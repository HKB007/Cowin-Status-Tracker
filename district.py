...
def parseArguments():
    ...
    parser.add_argument("statename", type=str, help="State of your district")
    parser.add_argument("districtname", type=str, help="District name to search for")
    parser.add_argument(
        "-age",
        metavar="yourage",
        type=int,
